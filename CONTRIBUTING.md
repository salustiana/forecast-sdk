...
Opening an issue is as easy as following [this link](https://github.com/mercadolibre/fury_python-bi-automl/issues/new) and filling out the given template.
...
## Developing python_bi_automl

To develop python_bi_automl
...
$ python3 -m venv venv
$ . venv/bin/activate
$ pip install --index-url http://pypi.ml.com/simple/ \
...
Fury libraries work with Libflow branching model, you could read more about that in the [docs](https://release-process.furycloud.io/#/lang-es/workflows/04_libflow?id=definici%c3%b3n).
